...
const I18N = {
  pl: {
    ...
    navMap: 'Mapa',
    navRanking: 'Ranking',
    navMethodology: 'Wyjaśnienia',
    methodologyTitle: 'Wyjaśnienia',
    methodologyLink: 'Jak liczone są wyniki? → Wyjaśnienia',
  ...
  en: {
    ...
    navMap: 'Map',
    navRanking: 'Ranking',
    navMethodology: 'Explained',
    methodologyTitle: 'Explained',
    methodologyLink: 'How are scores computed? → Explained',
